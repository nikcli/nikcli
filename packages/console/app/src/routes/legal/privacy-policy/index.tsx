...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>Nikcli | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="Nikcli privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Nikcli, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Nikcli is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://nikcli-ai.dev/legal/terms-of-service</a>,
              ...
              <ul>
                <li>
                  ...
                  sending you information about Nikcli.
                </li>
              ...
              <p>
                ...
                you, Nikcli or another party; enforcing any agreements with you; responding to claims that any posting
