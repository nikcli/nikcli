...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Nikcli | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Nikcli terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Nikcli. Please read on to learn the rules and restrictions that govern your use of Nikcli
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Nikcli," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://nikcli-ai.dev/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-nikcli">What is Nikcli?</h2>
              <p>
              ...
              <p>
                ...
                our site located at nikcli-ai.dev, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Nikcli takes the privacy of its users very seriously. For the current Nikcli Privacy Policy, please
                click here{" "}
                <a href="https://nikcli-ai.dev/legal/privacy-policy">https://nikcli-ai.dev/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Nikcli?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Nikcli;
                </li>
                <li>
              ...
              <p>
                If you use Nikcli with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Nikcli. Your ability to access Third Party Models is contingent on you having API keys or otherwise
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://nikcli-ai.dev/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://nikcli-ai.dev/auth">https://nikcli-ai.dev/auth</a>.
              </p>
              ...
              <p>
                ...
                the Nikcli Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Nikcli Parties harmless from and against any and all claims,
              ...
              <p>
                Either you or Nikcli may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                are not an employee, agent, partner, or joint venture of Nikcli, and you do not have any authority of
                any kind to bind Nikcli in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Nikcli
