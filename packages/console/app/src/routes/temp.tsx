    ...
    <main data-page="home">
      ...
      <div data-component="content">
        <section data-component="top">
          <img data-slot="logo light" src={logoLight} alt="nikcli logo light" />
          <img data-slot="logo dark" src={logoDark} alt="nikcli logo dark" />
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>nikcli-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>nikcli-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                brew install <strong>nikcli</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>nikcli-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          ...
          <div data-slot="cell">
            <a href="https://nikcli-ai.dev/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
