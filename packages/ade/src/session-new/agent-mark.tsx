  ...
  ohmypi: (size, colored) => {
    ...
    return (
      ...
      >
        ...
        <rect x="76" y="59" width="3" height="8" rx="1" fill={colored() ? "#0D0D0D" : "currentColor"} opacity={colored() ? "1" : "0"} />
        <rect x="82" y="59" width="3" height="8" rx="1" fill={colored() ? "#0D0D0D" : "currentColor"} opacity={colored() ? "1" : "0"} />
