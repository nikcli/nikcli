...
const TIPS = [
  ...
  "Create {highlight}nikcli.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/nikcli/tui.json{/highlight} for global config",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.nikcli/tools/{/highlight} to define new LLM tools",
