export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Nikcli",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Nikcli.",
  ...
  "provider.connect.nikcliZen.line1":
    "Nikcli Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.nikcliZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.nikcliZen.visit.prefix": "Odwiedź ",
  "provider.connect.nikcliZen.visit.link": "nikcli-ai.dev/zen",
  "provider.connect.nikcliZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Nikcli.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Nikcli.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w nikcli.json",
  ...
  "dialog.server.description": "Przełącz serwer Nikcli, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Nikcli ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Nikcli",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (nikcli.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Nikcli nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nikcli zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Nikcli",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Nikcli na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Nikcli.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Nikcli",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Nikcli.",
