export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Nikcli",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Nikcli.",
  ...
  "provider.connect.nikcliZen.line1":
    "Nikcli Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.nikcliZen.visit.prefix": "Visitez ",
  "provider.connect.nikcliZen.visit.link": "nikcli-ai.dev/zen",
  "provider.connect.nikcliZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Nikcli.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Nikcli.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans nikcli.json",
  ...
  "dialog.server.description": "Changez le serveur Nikcli auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Nikcli ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Nikcli",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (nikcli.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Nikcli ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Nikcli inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Nikcli",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Nikcli sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Nikcli.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Nikcli",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Nikcli.",
