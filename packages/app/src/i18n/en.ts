export const dict = {
  ...
  "settings.agents.description": "Enable or disable agents available in this project.",
  "settings.agents.empty": "No agents found for this project.",
  "settings.agents.mode.primary": "Primary",
  "settings.agents.mode.subagent": "Subagent",
  "settings.agents.mode.all": "All modes",
  "settings.agents.toast.updateFailed.title": "Failed to update agent",
  "settings.commands.title": "Commands",
  "settings.commands.description": "Slash commands loaded for this project.",
  "settings.commands.empty": "No commands found for this project.",
  "settings.commands.tag.slash": "Slash",
  "settings.commands.tag.subtask": "Subtask",
  "settings.mcp.title": "MCP",
  "settings.mcp.description": "Connect or disconnect MCP servers for this project.",
  "settings.features.title": "Features",
  "settings.features.description": "Turn experimental and product features on or off.",
  "settings.features.toast.updateFailed.title": "Failed to update feature",
  "settings.features.brain.title": "Brain",
  "settings.features.brain.description": "Automatically consolidate memory across sessions",
  "settings.features.memory.title": "Memory",
  "settings.features.memory.description": "Include memory files in session context",
  "settings.features.batchTool.title": "Batch tool",
  "settings.features.batchTool.description": "Allow the model to run multiple tools in one step",
  "settings.features.openTelemetry.title": "OpenTelemetry",
  "settings.features.openTelemetry.description": "Emit AI SDK spans when an OTLP endpoint is configured",
  "settings.features.nativeLlm.title": "Native LLM streaming",
  "settings.features.nativeLlm.description": "Use native model streaming instead of the AI SDK path",
  "settings.features.continueOnDeny.title": "Continue on deny",
  "settings.features.continueOnDeny.description": "Keep the agent loop running when a tool call is denied",
  "settings.features.pasteSummary.title": "Paste summary",
  "settings.features.pasteSummary.description": "Summarize large pasted text before sending it to the model",
  "settings.worktrees.title": "Worktrees",
  "settings.worktrees.description": "Manage git worktrees and workspace startup for this project.",
  "settings.worktrees.empty.project": "Open a project to configure this.",
  "settings.worktrees.enabled.title": "Show workspaces",
  "settings.worktrees.enabled.description": "List linked worktrees in the sidebar",
  "settings.worktrees.section.list": "Worktrees",
  ...
  "github.account.connectHint": "Approve your GitHub account. Nikcli already uses the official GitHub App.",
  "github.account.disconnect": "Disconnect",
  "github.oauth.clientTitle": "OAuth application",
  "github.oauth.clientDescription":
    "Optional. Nikcli already uses the official GitHub App by default — set a custom client ID only if you need a different OAuth application.",
  "github.oauth.clientId": "GitHub OAuth client ID",
  "github.oauth.title": "Device sign-in",
  "github.oauth.description": "Authorize Nikcli in your browser. You only need to approve your GitHub account.",
