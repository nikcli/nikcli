export const dict = {
  ...
  "dialog.provider.nikcli.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Nikcli",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Nikcli-u.",
  ...
  "provider.connect.nikcliZen.line1":
    "Nikcli Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.nikcliZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.nikcliZen.visit.prefix": "Posjeti ",
  "provider.connect.nikcliZen.visit.link": "nikcli-ai.dev/zen",
  "provider.connect.nikcliZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Nikcli-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Nikcli-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u nikcli.json",
  ...
  "dialog.server.description": "Promijeni na koji se Nikcli server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Nikcli-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Nikcli timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (nikcli.json) - nazive provajdera/modela",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Nikcli još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Nikcli uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Nikcli-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Nikcli izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Nikcli-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Nikcli pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Nikcli-a.",
