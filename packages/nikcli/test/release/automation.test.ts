...
describe("ADE release integration", () => {
  ...
  it("builds all six desktop targets and gates native builds on ADE checks", async () => {
    ...
    expect(ade).toContain(
      "((github.repository == 'nikomatt69/nikcli' || github.repository == 'nikcli/nikcli') && inputs.attach_only)",
    )
    expect(checks).toContain(
      "((github.repository == 'nikomatt69/nikcli' || github.repository == 'nikcli/nikcli') && inputs.ref != '')",
    )
