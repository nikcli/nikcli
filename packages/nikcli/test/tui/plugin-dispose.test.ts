...
import { activatePluginEntry, createPluginScope, deactivatePluginEntry } from "@tui/plugin/runtime"
...
describe("plugin activation ownership", () => {
  test.each([false, true])("late activation cannot replace a newer generation (reject=%s)", async (reject) => {
